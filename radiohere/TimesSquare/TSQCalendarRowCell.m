...
- (void)createDayButtons;
{
    ...
    for (NSUInteger index = 0; index < self.daysInWeek; index++) {
        ...
        [button setTitleColor:[self.textColor colorWithAlphaComponent:0.1f] forState:UIControlStateDisabled];
    }
...
- (void)createNotThisMonthButtons;
{
    ...
    for (NSUInteger index = 0; index < self.daysInWeek; index++) {
        ...
        [button setTitleColor:[self.textColor colorWithAlphaComponent:0.0f] forState:UIControlStateNormal];
    }
...
//    [self.selectedButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self.selectedButton setTitleColor:[self.textColor colorWithAlphaComponent:0.1f] forState:UIControlStateDisabled];
